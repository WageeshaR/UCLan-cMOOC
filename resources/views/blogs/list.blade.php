        ...
        <div class="panel">
            <div class="panel-heading">
                <div class="panel-title">
                    <a href="{{ route('student.blogForm') }}" class="btn btn-success btn-sm"><i class="icon wb-plus" aria-hidden="true"></i> Add Blog</a>
                </div>

                <div class="panel-actions">
                    <form method="GET" action="{{ route('student.blogs.index') }}">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @if(Auth::user()->id == $blog->author_id)
                                    <a href="{{ url('blog-form/'.$blog->id) }}" class="btn btn-xs btn-icon btn-inverse btn-round" data-toggle="tooltip" data-original-title="Edit" >
                                        <i class="icon wb-pencil" aria-hidden="true"></i>
                                    </a>
                                    <a href="{{ url('delete-blog/'.$blog->id) }}" class="delete-record btn btn-xs btn-icon btn-inverse btn-round" data-toggle="tooltip" data-original-title="Delete" >
